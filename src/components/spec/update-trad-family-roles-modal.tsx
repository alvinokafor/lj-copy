...
const UpdateTradFamilyRolesModal = forwardRef<BottomSheetModal>(
  (_props, ref) => {
    ...
    const handleUpdateTraditionalRoles = async () => {
      try {
        await mutateAsync({
          ...
          <BottomSheetView>
            <View style={{ paddingBottom: theme.space[12] }}>
              ...
              <View style={{ paddingTop: theme.space[20] }}>
                ...
                >
                  How do you feel about traditional family roles?
                </Text>
              </View>
              ...
              >
                <Button
                  ...
                  disabled={reply === ""}
                  isLoading={isPending}
                  onPress={handleUpdateTraditionalRoles}
                />
                <Button
                  title="Cancel"
                  titleStyle={{
...
export default UpdateTradFamilyRolesModal;
