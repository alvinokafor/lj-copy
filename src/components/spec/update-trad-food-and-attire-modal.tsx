...
const UpdateTradFoodAndAttireModal = forwardRef<BottomSheetModal>(
  (_props, ref) => {
    ...
    const handleUpdateTraditionalFoodOrAttire = async () => {
      try {
        await mutateAsync({
          traditional: reply,
        });
        queryClient.setQueryData(
          ...
          (oldData: UserProfileResponse) => {
            return {
              ...
              data: {
                ...oldData.data,
                traditional_food_or_attire: reply,
              },
            };
          }
        );
          ...
          <BottomSheetView>
            <View style={{ paddingBottom: theme.space[12] }}>
              ...
              <View style={{ paddingTop: theme.space[20] }}>
                ...
                >
                  How often do you eat traditional foods or wear traditional
                  attire?
                </Text>
              </View>
              ...
              >
                <Button
                  ...
                  disabled={reply === ""}
                  isLoading={isPending}
                  onPress={handleUpdateTraditionalFoodOrAttire}
                />
                <Button
                  title="Cancel"
                  titleStyle={{
...
export default UpdateTradFoodAndAttireModal;
