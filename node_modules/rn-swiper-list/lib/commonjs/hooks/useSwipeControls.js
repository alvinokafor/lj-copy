...
const useSwipeControls = data => {
  ...
  const swipeBottom = (0, _react.useCallback)(() => {
    var _refs$activeIndex$val4;
    if (!refs[activeIndex.value]) {
      return;
    }
    (_refs$activeIndex$val4 = refs[activeIndex.value]) === null || _refs$activeIndex$val4 === void 0 || (_refs$activeIndex$val4 = _refs$activeIndex$val4.current) === null || _refs$activeIndex$val4 === void 0 || _refs$activeIndex$val4.swipeBottom();
  }, [activeIndex.value, refs]);
